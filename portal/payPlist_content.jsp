...
<%
	...
	out.println("<center><h2><a href='control_data.jsp?action=pp_list'>[결제내역 목록 보기_상품]</a></h2></center>");
	out.println("<center> ");
		...
		// index 보여주기
				for (int k = 1; k <= size; k++) {
					...
					if (k == (index + 1)){
						...
						out.println("<a href=\"control_data.jsp?action=pp_list&index=" + (k - 1) + "\">&nbsp;" + k
								+ "</a>&nbsp;");
				...
				out.println("<table style='width:850px;' class='table table-bordered table-hover' border='1' cellspacing=0 align=center>");

				out.println("<tr><th>번호</th><th>결제내역 id</th><th>카드이름</th>"
						+"<th>결제 일</th><th>결제 양</th><th>상품 이름</th><th>고객 명</th><th>결제 수단</th><th>비콘 ID</th></tr>");
