...
<%
	...
	// 값 조회시 보여주는 리스트
	out.println("<center><h2><a href='control_data.jsp?action=uM_list'>[전체 목록 보기]</a></h2></center>");
	if (request.getAttribute("userID") != null) {
		// index 보여주기
				...
				out.println("<tr align = center><th align='center'>번호</th><th align='center'>사용자 id</th><th align='center'>사용자<br> password</th><th align='center'>사용자 이름</th><th align='center'>사용자 E-Mail</th><th align='center'>ANDROID_ID</th><th align='center'>연령대 구분</th><th align='center'>관심사</th></tr>");
				for (int j = start; j < end; j++) {
					list = userList.get(j);
					int tp = j+1;
					out.println("<tr align = center>");
					out.println("<td>" + tp + "</td>");
					out.println("<td><a href=\"control_data.jsp?action=uM_list&userID="+ list.getUserID() + "\">&nbsp;"+list.getUserID()+"</a></td>");
